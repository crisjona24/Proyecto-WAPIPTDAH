...
// Metodos
import { FormularioCurso } from "../../components/registro/Formularios"

export function CursoRegistro() {
    return (
                ...
                <Container className='barraSup mt-5' >
                    <Row className='col-md-12'>
                        <div className="card-body col-md-9">
                            <h4 style={{ padding: '10px', fontSize: '1.5rem', paddingTop: '15px' }}> Registro de Curso</h4>
                        </div>
